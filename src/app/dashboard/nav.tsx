...
export default function WorkspaceNav({ actionsCount = 0, spreadsheetUrl }: { actionsCount?: number; spreadsheetUrl?: string }) {
  ...
  return <nav aria-label="Workspace">
    ...
    <a href="https://rekodja.com/" target="_blank" rel="noreferrer" onClick={(event) => { if (!window.confirm('Open the RekodJa extension website?')) event.preventDefault(); }}>Extension</a>
    {spreadsheetUrl && <a href={spreadsheetUrl} target="_blank" rel="noreferrer">Spreadsheet</a>}
  </nav>;
}
